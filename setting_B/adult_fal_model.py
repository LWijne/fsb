...
print("auc_fal_setB_adult =", auc_list.tolist())
print("sdp_fal_setB_adult =", sdp_list.tolist())
print("std_auc_fal_setB_adult =", std_auc_list.tolist())
print("std_sdp_fal_setB_adult =", std_sdp_list.tolist())
