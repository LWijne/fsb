...
print("auc_flr_setA_adult =", auc_list.tolist())
print("sdp_flr_setA_adult =", sdp_list.tolist())
print("std_auc_flr_setA_adult =", std_auc_list.tolist())
print("std_sdp_flr_setA_adult =", std_sdp_list.tolist())