...
print("auc_frf_setA =", auc_list.tolist())
print("sdp_frf_setA =", sdp_list.tolist())
print("std_auc_frf_setA =", std_auc_list.tolist())
print("std_sdp_frf_setA =", std_sdp_list.tolist())
