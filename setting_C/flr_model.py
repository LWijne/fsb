...
print("auc_flr_setC =", auc_list.tolist())
print("sdp_flr_setC =", sdp_list.tolist())
print("std_auc_flr_setC =", std_auc_list.tolist())
print("std_sdp_flr_setC =", std_sdp_list.tolist())
