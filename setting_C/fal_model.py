...
print("auc_fal_setC =", auc_list.tolist())
print("sdp_fal_setC =", sdp_list.tolist())
print("std_auc_fal_setC =", std_auc_list.tolist())
print("std_sdp_fal_setC =", std_sdp_list.tolist())