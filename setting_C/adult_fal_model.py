...
print("auc_fal_setC_adult =", auc_list.tolist())
print("sdp_fal_setC_adult =", sdp_list.tolist())
print("std_auc_fal_setC_adult =", std_auc_list.tolist())
print("std_sdp_fal_setC_adult =", std_sdp_list.tolist())
